...
PATCHES=(
	"${FILESDIR}/${FILESDIR}/0001"-ENH-Update-cmake-requirements.patch
	"${FILESDIR}/${FILESDIR}/0002"-ENH-Remove-the-use-of-Qt4.patch
	"${FILESDIR}/${FILESDIR}/0003"-ENH-Refactor-CMake-project-definition.patch
)
