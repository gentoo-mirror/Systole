...
PATCHES=(
	"${FILESDIR}/${FILESDIR}/0001"-ENH-Add-versioning-and-use-of-CMake-GNUInstallDirs.patch
	"${FILESDIR}/${FILESDIR}/0002"-ENH-Add-CMake-directory-to-CMAKE_MODULE_PATH.patch
	"${FILESDIR}/${FILESDIR}/0003"-ENH-Modernize-Python-finding.patch
)
