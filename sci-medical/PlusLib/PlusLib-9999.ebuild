...
PATCHES=(
	"${FILESDIR}/${FILESDIR}/0001"-ENH-Fix-compile-using-install-tree-of-dependencies.patch
	"${FILESDIR}/${FILESDIR}/0002"-ENH-Modify-loading-of-configuration-to-fit-system-in.patch
)
