...
PATCHES=(
	"${FILESDIR}/${FILESDIR}/0001"-ENH-Include-missing-files.patch
	"${FILESDIR}/${FILESDIR}/0002"-ENH-Change-installation-path-for-python-wrapped-file.patch
	"${FILESDIR}/${FILESDIR}/0003"-ENH-Include-missing-ctkFunctionExtractOptimizedLibra.patch
	"${FILESDIR}/${FILESDIR}/0004"-ENH-Make-use-of-CMake-GNUInstallDirs-module.patch
	"${FILESDIR}/${FILESDIR}/0005"-ENH-Enable-more-selective-installation-of-python-fil.patch
	"${FILESDIR}/${FILESDIR}/0006"-ENH-Modernize-Python-detection.patch
	"${FILESDIR}/${FILESDIR}/0007"-ENH-Remove-installation-step-from-ctkMacroCompilePyt.patch
)
