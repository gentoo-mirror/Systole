...
PATCHES=(
	"${FILESDIR}/${FILESDIR}/0001"-COMP-Adapt-vmtk-to-ITK-5.1.patch
	"${FILESDIR}/${FILESDIR}/0002"-COMP-Remove-install-sentence-for-VMTK-Targets.patch
	"${FILESDIR}/${FILESDIR}/0003"-ENH-Change-variables-definition-check.patch
)
